...
#define NEW_DYNAREC NEW_DYNAREC_ARM
...
/* instruction types */
#define INSTR_NOP 0 // No operation
#define INSTR_LOAD 1 // Load
#define INSTR_STORE 2 // Store
#define INSTR_LOADLR 3 // Unaligned load
#define INSTR_STORELR 4 // Unaligned store
#define INSTR_MOV 5 // Move 
#define INSTR_ALU 6 // Arithmetic/logic
#define INSTR_MULTDIV 7 // Multiply/divide
#define INSTR_SHIFT 8 // Shift by register
#define INSTR_SHIFTIMM 9 // Shift by immediate 
#define INSTR_IMM16 10 // 16-bit immediate
